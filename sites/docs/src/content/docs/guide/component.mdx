...
But this is the exact trade-off Rin makes intentionally. We chose plain JavaScript predictability over compiler magic or reactive proxies. By forcing you to read directly from `props`, we guarantee your closures behave exactly like normal JavaScript closures always have. 
