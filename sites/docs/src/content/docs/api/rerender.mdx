...
The global `rerender()` utility is how you tell Rin that something has changed and the UI needs to catch up. It is the manual override for state updates.
...
It is explicit and fast. If you tell Rin to rerender, it rerenders. If you do not, it stays quiet.
